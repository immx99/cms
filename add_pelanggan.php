			  ...
			  <div class="row">
				...
				<div class="row">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" value="<?php echo $nama; ?>" placeholder="Masukan Nama Pelanggan" maxlength="50" required>
        ...
        <div class="row">
           ...
           <div class="form-group col-md-6 col-xs-12" >
				...
				<div class="row">
                  ...
                  <textarea class="form-control" rows="3" id="alamat" name="alamat" maxlength="255" placeholder="Masukan alamat" required><?php echo $alamat; ?></textarea>
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $result=mysqli_query($conn,$sql);
          ...
          echo "<script type='text/javascript'>window.location = '$forwardpage';</script>";
					 ...
					 $sql2 = "insert into $tabeldatabase values( '$kode','$tgldaftar','$nama','$alamat',
            '$telepon','$kecamatan','$nohp','$url', '$peta_lokasi', NULL )";
          //  echo $sql2;
